...
def launch(textLabel):
    ...
    threading.Thread(target = sc.start()).start()
...
emptyLabel_a0 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a0.grid(row = 0, column = 0)
emptyLabel_a1 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a1.grid(row = 0, column = 1)
emptyLabel_a2 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a2.grid(row = 0, column = 2)
emptyLabel_a3 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a3.grid(row = 0, column = 3)
emptyLabel_a4 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a4.grid(row = 0, column = 4)
emptyLabel_a5 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a5.grid(row = 0, column = 5)
emptyLabel_a6 = tk.Label(root, height = 1, text = labelString)
emptyLabel_a6.grid(row = 0, column = 6)
emptyLabel_a7 = tk.Label(root, height = 1, text = labelString)
...
serverButton.grid(row = 2, column = 1, rowspan = 2, columnspan = 2, sticky = "ew")
